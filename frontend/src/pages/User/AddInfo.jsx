...
import { addInfo } from "@/Redux/Info/Action";
...
const AddInfo = () => {
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(addInfo(formData,auth.user,navigate));
    };

    return (
        <div className="p-10 flex flex-col justify-start items-center">
            <h1 className="text-3xl font-medium text-gray-700 mb-6 border-b-4 w-full">Add Info</h1>
            <form onSubmit={handleSubmit} encType="multipart/form-data" className="w-[60%] ">
                ...
                <div className="p-4 flex flex-col justify-center items-center">
                    ...
                    <div className="flex items-center pt-3 space-x-3 text-left w-[90%] mb-10">
                            <Checkbox id="terms" checked={isChecked} onCheckedChange={setIsChecked} />
                            <label
                                htmlFor="terms"
                                className="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                            >
                                I confirm that all the information provided is true and correct to the best of my knowledge. In case of any discrepancies, I take full responsibility for rectifying them.
                            </label>
                    </div>
                    
                    <div className="flex justify-around w-[50%]">
                        <Button type="submit" className="w-[7rem] bg-green-700" disabled={!isChecked}>Add Info</Button>
